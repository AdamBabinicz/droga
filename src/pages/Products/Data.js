...
export const homeObjTwo = {
  ...
  description:
    "Ojciec Franciszka, Wojciech wraz z żoną Józefą Rzeszót oraz rodziną, mieszkali w czworakach. Dziadek pracował we dworze. Miał liczną rodzinę. Oprócz Franciszka wychowywał Stanisława, Juliana i Antka. Zawodowo zajmował się robotami stolarskimi i ciesielskimi.",
  description1:
    "Należy tu wspomnieć, że czasy, o których mowa dotyczyły zaboru rosyjskiego w którym pańszczyzna została zniesiona w 1864 r. Ojciec Franciszka nie doczekał sędziwego wieku, ale jego synowie byli już dorośli, aby wyfrunąć z rodzinnego gniazda.",
...
export const homeObjThree = {
  ...
  lightTextDesc: false,
  primary: true,
  topLine: "Józefa Gutkowska/Tokarska z d. Rzeszót (Rzeszut)",
  headLine: "Moja babcia ze strony ojca",
  description:
    "Wdowa po dziadku wkrótce wyszła za mąż za kawalera z miejscowego środowiska, Jana Tokarskiego. Z tego związku urodzili się Roman (1904), Janek, Marysia (1906) i Katarzyna (1908). Przyrodnie rodzeństwo nawzajem się szanowało i cała rodzina żyła w zgodzie.",
  description1:
